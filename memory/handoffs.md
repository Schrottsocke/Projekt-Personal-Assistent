...
- **Webapp Feature-Phase**: Issue-Liste live. VPS Setup komplett (Repo geklont, venv, .env, Services). GITHUB_TOKEN auf VPS eingetragen (muss rotiert werden – war im Chat sichtbar). Naechste Features: Issue-Detailansicht, Label-Filter, oder andere Webapp-Views funktional machen. Token-Rotation nicht vergessen. (2026-04-01)
